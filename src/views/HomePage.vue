<template>
  <div class="container" :style="containerStyle">
    ...
    <MyGameLibrary :data="gameLibrary" v-if="selectedId == 0" @mouse-message="mouseMessage"></MyGameLibrary>
...
const gameLibrary = ref([{ name: '1233', pic: 'https://img1.baidu.com/it/u=1005000719,311741344&fm=253&fmt=auto&app=138&f=JPEG?w=889&h=500', id: -1 }])
const bgPic = ref('')
